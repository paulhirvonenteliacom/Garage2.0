namespace Garage2._0.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Garage2._0.DataAccess.GarageContext>
    {
        public Configuration()
        {
            ...
            ContextKey = "Garage2._0.DataAccess.GarageContext";
        }
        ...
        protected override void Seed(Garage2._0.DataAccess.GarageContext context)
        {
            ...
            //     v => v.RegNumber,
            //     new Vehicle { RegNumber = "QSW098", Brand = "BMW", Model = "520d", Color = "Svart", NoOfWheels = 4, CheckInTime = DateTime.Now },
            //     new Models.ParkedVehicle { TypeOfVehicle = VehicleType.Car, RegNumber = "EDC321", Brand = "FIAT", Model = "500L", Color = "Gul", NoOfWheels = 4, CheckInTime = DateTime.Now },
